namespace Goreu.Services.Interface
{
    public interface IUserService
    {
        ...
        Task<BaseResponseGeneric<UsuarioResponseDto>> GetByIdPersonaAsync(int idPersona);
        Task<BaseResponseGeneric<UsuarioResponseDto>> GetByIdAsync(string userId);
        //--------------------------------------------------------------------------------------------
        ...
        Task<BaseResponseGeneric<ICollection<UsuarioResponseDto>>> GetAsync(int idEntidad, int idAplicacion, string? rolId, string? search, PaginationDto? pagination);
